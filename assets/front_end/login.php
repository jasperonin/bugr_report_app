       ...
       <div class="row justify-content-md-center">
           ...
           <div class="col-md-5">
               <div class="card w-100 border-0">
                   ...
                   <img src="https://pbs.twimg.com/profile_images/1610445215902609408/8AocNFE6_400x400.jpg" class="custom-img">  
                          ...
                          <div class="form-floating my-2"> 
                           ...
                           <div class="form-check text-left">
                               <div class="row">
                                   ...
                                   <a href="/reset"><small class="text-right">Forgot Password?</small></a>
                                   </div>
                               </div>
                           </div>
                      
                           <div class="text-center">
                               <button class="btn btn-outline-primary btn-block mt-3">Login</button>
                           </div>
